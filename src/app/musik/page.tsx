...
export const metadata: Metadata = {
  ...
  description: "Lagets gemensamma spellista och BK Zeros AI-låtar – snart här.",
};
    ...
    <main className="mx-auto w-full max-w-xl px-4 pb-16">
      ...
      <section className="rounded-2xl bg-white p-6 text-center shadow-card sm:p-8">
        ...
        <p className="mx-auto mt-3 max-w-sm text-base font-semibold text-ink/80">
          Snart drar vi igång en gemensam spellista där alla kan lägga till sina
          favoritlåtar – plus BK Zeros egna AI-låtar. 🎶 Håll utkik!
        </p>
      </section>
    </main>
  );
